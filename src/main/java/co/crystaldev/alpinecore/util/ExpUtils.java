 ...
 *
 * @see <a href="https://github.com/Jikoo/PlanarWrappers/blob/master/src/main/java/com/github/jikoo/planarwrappers/util/Experience.java">Experience.java</a>
 * @author Jikoo
 * @since 0.1.0
 */
@UtilityClass
public final class ExpUtils {
     ...
     * {@link Player#giveExp(int)}.
     * <p>
     * In older versions the method does not take differences in exp per level into account. This
     * leads to over leveling when granting players large amounts of experience.
     * <p>
